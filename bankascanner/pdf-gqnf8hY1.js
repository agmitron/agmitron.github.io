var ce = {
  ...
  4358: (
    /***/
    ((w, D, t) => {
      var s = t(9298), g = t(8403), u = t(1299), A = t(9548), b = t(582), S = t(7585), p = t(8126), m = t(4837), o = s.structuredClone, l = s.ArrayBuffer, c = s.DataView, r = s.TypeError, f = Math.min, e = l.prototype, i = c.prototype, y = g(e.slice), T = u(e, "resizable", "get"), E = u(e, "maxByteLength", "get"), R = g(i.getInt8), L = g(i.setInt8);
      w.exports = (m || p) && function(M, $, j) {
        var K = S(M), Q = $ === void 0 ? K : A($), J = !T || !T(M), at;
        if (b(M))
    ...
    ((w, D, t) => {
      var s = t(5115), g = t(940), u = t(9298), A = t(7316), b = t(7633), S = t(936), p = t(8329), m = t(9762), o = t(9293), l = t(7041), c = t(9691), r = t(2658), f = t(2176), e = t(9763), i = t(2292), y = t(7561), T = t(1649), E = T.enforce, R = T.get, L = u.Int8Array, M = L && L.prototype, $ = u.Uint8ClampedArray, j = $ && $.prototype, K = L && f(L), Q = M && f(M), J = Object.prototype, at = u.TypeError, ut = i("toStringTag"), ht = y("TYPED_ARRAY_TAG"), _ = "TypedArrayConstructor", Z = s && !!e && p(u.opera) !== "Opera", z = !1, V, nt, ot, lt = {
        ...
        if (!b(x))
          return !1;
        var C = p(x);
        return C === "DataView" || S(lt, C) || S(vt, C);
      }, xt = function(d) {
        var x = f(d);
        if (b(x)) {
          var C = R(x);
          return C && S(C, _) ? C[_] : xt(x);
        }
      }, tt = function(d) {
        if (!b(d))
          return !1;
        var x = p(d);
        return S(lt, x) || S(vt, x);
      }, v = function(d) {
        if (tt(d))
          return d;
  ...
  7003: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(g, u, A) {
        for (var b = 0, S = arguments.length > 2 ? A : s(u), p = new g(S); S > b; )
          p[b] = u[b++];
        return p;
      };
    })
  ...
  4026: (
    /***/
    ((w, D, t) => {
      var s = t(7789), g = t(3622), u = t(2007), A = t(451), b = function(S) {
        var p = S === 1;
  ...
  6661: (
    ...
    ((w, D, t) => {
      ...
      w.exports = b ? function(S, p) {
        if (g(S) && !A(S, "length").writable)
  ...
  2304: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(g, u) {
        for (var A = s(g), b = new u(A), S = 0; S < A; S++)
          b[S] = g[A - S - 1];
        return b;
      };
    })
  ...
  5886: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(A, b, S, p) {
        var m = s(A), o = g(S), l = o < 0 ? m + o : o;
        if (l >= m || l < 0)
  ...
  5723: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(u, A, b, S) {
        try {
          return S ? A(s(b)[0], b[1]) : A(b);
        } catch (p) {
          g(u, "throw", p);
        }
      };
  ...
  8329: (
    /***/
    ((w, D, t) => {
      var s = t(3077), g = t(7316), u = t(8374), A = t(2292), b = A("toStringTag"), S = Object, p = u(/* @__PURE__ */ (function() {
        return arguments;
      ...
      w.exports = s ? u : function(o) {
        var l, c, r;
        return o === void 0 ? "Undefined" : o === null ? "Null" : typeof (c = m(l = S(o), b)) == "string" ? c : p ? u(l) : (r = u(l)) === "Object" && g(l.callee) ? "Arguments" : r;
      };
    })
  ),
  /***/
  1425: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(b, S, p) {
        for (var m = g(S), o = A.f, l = u.f, c = 0; c < m.length; c++) {
          var r = m[c];
          !s(b, r) && !(p && s(p, r)) && o(b, r, l(S, r));
        }
      };
    })
  ),
  ...
  9293: (
    ...
    ((w, D, t) => {
      ...
      w.exports = s ? function(A, b, S) {
        return g.f(A, b, u(1, S));
      } : function(A, b, S) {
        return A[b] = S, A;
      };
    })
  ...
  8947: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(A, b, S) {
        var p = s(b);
        p in A ? g.f(A, p, u(0, S)) : A[p] = S;
      };
    })
  ),
  /***/
  ...
  7041: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(b, S, p, m) {
        m || (m = {});
        var o = m.enumerable, l = m.name !== void 0 ? m.name : S;
        if (s(p) && u(p, l, m), m.global)
          o ? b[S] = p : A(S, p);
        else {
          try {
            m.unsafe ? b[S] && (o = !0) : delete b[S];
          } catch {
          }
          o ? b[S] = p : g.f(b, S, {
            value: p,
  ...
  8126: (
    /***/
    ((w, D, t) => {
      var s = t(9298), g = t(2276), u = t(4837), A = s.structuredClone, b = s.ArrayBuffer, S = s.MessageChannel, p = !1, m, o, l, c;
      if (u)
        p = function(r) {
          A(r, { transfer: [r] });
        };
        ...
        try {
          S || (m = g("worker_threads"), m && (S = m.MessageChannel)), S && (o = new S(), l = new b(2), c = function(r) {
  ...
  2171: (
    /***/
    ((w, D, t) => {
      var s = t(9298), g = t(234), u = s.process, A = s.Deno, b = u && u.versions || A && A.version, S = b && b.v8, p, m;
      S && (p = S.split("."), m = p[0] > 0 && p[0] < 4 ? 1 : +(p[0] + p[1])), !m && g && (p = g.match(/Edge\/(\d+)/), (!p || p[1] >= 74) && (p = g.match(/Chrome\/(\d+)/), p && (m = +p[1]))), w.exports = m;
    })
  ),
  /***/
  298: (
  ...
  34: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(p, m) {
        if (S && typeof p == "string" && !g.prepareStackTrace)
          for (; m--; )
            p = u(p, b, "");
        return p;
      };
  ...
  4978: (
    /***/
    ((w, D, t) => {
      var s = t(9298), g = t(5764).f, u = t(9293), A = t(7041), b = t(6e3), S = t(1425), p = t(7007);
  ...
  7789: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(b, S) {
        return g(b), S === void 0 ? b : u ? A(b, S) : function() {
          return b.apply(S, arguments);
        };
      };
    })
  ),
  ...
  5145: (
    /***/
    ((w, D, t) => {
      var s = t(940), g = t(936), u = Function.prototype, A = s && Object.getOwnPropertyDescriptor, b = g(u, "name"), S = b && function() {
  ...
  273: (
    /***/
    ((w, D, t) => {
      var s = t(8329), g = t(8486), u = t(3734), A = t(6596), b = t(2292), S = b("iterator");
      w.exports = function(p) {
        if (!u(p))
          return g(p, S) || g(p, "@@iterator") || A[s(p)];
      };
    })
  ),
  /***/
  7612: (
    /***/
    ((w, D, t) => {
      var s = t(2026), g = t(1782), u = t(4719), A = t(9762), b = t(273), S = TypeError;
      w.exports = function(p, m) {
        var o = arguments.length < 2 ? b(p) : m;
        if (g(o))
          return u(s(o, p));
        throw new S(A(p) + " is not iterable");
      };
    })
  ),
  /***/
  ...
  1096: (
    /***/
    ((w, D, t) => {
      var s = t(1782), g = t(4719), u = t(2026), A = t(1003), b = t(9235), S = "Invalid size", p = RangeError, m = TypeError, o = Math.max, l = function(c, r, f, e) {
  ...
  936: (
    ...
    ((w, D, t) => {
      ...
      w.exports = Object.hasOwn || function(b, S) {
        return u(g(b), S);
      };
    })
  ),
  ...
  7523: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(A, b, S) {
        var p, m;
        return u && s(p = b.constructor) && p !== S && g(m = p.prototype) && m !== S.prototype && u(A, m), A;
      };
    })
  ),
  /***/
  ...
  1649: (
    /***/
    ((w, D, t) => {
      var s = t(8443), g = t(9298), u = t(7633), A = t(9293), b = t(936), S = t(7542), p = t(3727), m = t(6010), o = "Object already initialized", l = g.TypeError, c = g.WeakMap, r, f, e, i = function(R) {
        return e(R) ? f(R) : r(R, {});
      }, y = function(R) {
        return function(L) {
          var M;
  ...
  7007: (
    ...
    ((w, D, t) => {
      ...
      }, S = A.data = {}, p = A.NATIVE = "N", m = A.POLYFILL = "P";
      w.exports = A;
    })
  ),
  /***/
  ...
  7814: (
    ...
    ((w, D, t) => {
      ...
      w.exports = A ? function(S) {
        return typeof S == "symbol";
      } : function(S) {
        var p = s("Symbol");
        return g(p) && u(p.prototype, b(S));
      };
    })
  ),
  /***/
  5504: (
    ...
    ((w, D, t) => {
      var s = t(2026);
      w.exports = function(g, u, A) {
        for (var b = A ? g : g.iterator, S = g.next, p, m; !(p = s(S, b)).done; )
  ...
  6837: (
    /***/
    ((w, D, t) => {
      var s = t(7789), g = t(2026), u = t(4719), A = t(9762), b = t(5191), S = t(451), p = t(2658), m = t(7612), o = t(273), l = t(3316), c = TypeError, r = function(e, i) {
  ...
  375: (
    /***/
    ((w, D, t) => {
      var s = t(2026), g = t(6941), u = t(9293), A = t(6880), b = t(2292), S = t(1649), p = t(8486), m = t(5238).IteratorPrototype, o = t(1111), l = t(3316), c = b("toStringTag"), r = "IteratorHelper", f = "WrapForValidIterator", e = S.set, i = function(E) {
        var R = S.getterFor(E ? f : r);
        return A(g(m), {
          next: function() {
            var M = R(this);
            if (E)
  ...
  8142: (
    /***/
    ((w, D, t) => {
      var s = t(2026), g = t(1782), u = t(4719), A = t(9235), b = t(375), S = t(5723), p = b(function() {
        var m = this.iterator, o = u(s(this.next, m)), l = this.done = !!o.done;
        if (!l)
          return S(m, this.mapper, [
            o.value,
            this.counter++
          ], !0);
      });
  ...
  5238: (
    /***/
    ((w, D, t) => {
      var s = t(8154), g = t(7316), u = t(7633), A = t(6941), b = t(2176), S = t(7041), p = t(2292), m = t(2554), o = p("iterator"), l = !1, c, r, f;
      [].keys && (f = [].keys(), "next" in f ? (r = b(b(f)), r !== Object.prototype && (c = r)) : l = !0);
      var e = !u(c) || s(function() {
        var i = {};
        return c[o].call(i) !== i;
      });
      e ? c = {} : m && (c = A(c)), g(c[o]) || S(c, o, function() {
        return this;
      }), w.exports = {
        IteratorPrototype: c,
  ...
  9687: (
    /***/
    ((w, D, t) => {
      var s = t(8403), g = t(8154), u = t(7316), A = t(936), b = t(940), S = t(5145).CONFIGURABLE, p = t(4993), m = t(1649), o = m.enforce, l = m.get, c = String, r = Object.defineProperty, f = s("".slice), e = s("".replace), i = s([].join), y = b && !g(function() {
        return r(function() {
        }, "length", { value: 8 }).length !== 8;
      }), T = String(String).split("String"), E = w.exports = function(R, L, M) {
        f(c(L), 0, 7) === "Symbol(" && (L = "[" + e(c(L), /^Symbol\(([^)]*)\)/, "$1") + "]"), M && M.getter && (L = "get " + L), M && M.setter && (L = "set " + L), (!A(R, "name") || S && R.name !== L) && (b ? r(R, "name", {
          value: L,
          configurable: !0
  ...
  6941: (
    /***/
    ((w, D, t) => {
      var s = t(4719), g = t(6617), u = t(298), A = t(6010), b = t(519), S = t(5584), p = t(3727), m = ">", o = "<", l = "prototype", c = "script", r = p("IE_PROTO"), f = function() {
      }, e = function(R) {
  ...
  6617: (
    /***/
    ((w, D, t) => {
      var s = t(940), g = t(9610), u = t(7744), A = t(4719), b = t(4115), S = t(1706);
      D.f = s && !g ? Object.defineProperties : function(m, o) {
        A(m);
        for (var l = b(o), c = S(o), r = c.length, f = 0, e; r > f; )
          u.f(m, e = c[f++], l[e]);
        return m;
      };
    })
  ...
  7744: (
    /***/
    ((w, D, t) => {
      var s = t(940), g = t(9394), u = t(9610), A = t(4719), b = t(4871), S = TypeError, p = Object.defineProperty, m = Object.getOwnPropertyDescriptor, o = "enumerable", l = "configurable", c = "writable";
  ...
  5764: (
    /***/
    ((w, D, t) => {
      var s = t(940), g = t(2026), u = t(1879), A = t(1198), b = t(4115), S = t(4871), p = t(936), m = t(9394), o = Object.getOwnPropertyDescriptor;
  ...
  2176: (
    /***/
    ((w, D, t) => {
      var s = t(936), g = t(7316), u = t(2007), A = t(3727), b = t(7888), S = A("IE_PROTO"), p = Object, m = p.prototype;
  ...
  9138: (
    /***/
    ((w, D, t) => {
      var s = t(8403), g = t(936), u = t(4115), A = t(9773).indexOf, b = t(6010), S = s([].push);
      w.exports = function(p, m) {
        var o = u(p), l = 0, c = [], r;
        for (r in o)
          !g(b, r) && g(o, r) && S(c, r);
        for (; m.length > l; )
          g(o, r = m[l++]) && (~A(c, r) || S(c, r));
        return c;
      };
    })
  ),
  ...
  9763: (
    ...
    ((w, D, t) => {
      ...
      w.exports = Object.setPrototypeOf || ("__proto__" in {} ? (function() {
        var A = !1, b = {}, S;
        try {
          S = s(Object.prototype, "__proto__", "set"), S(b, []), A = b instanceof Array;
        } catch {
        }
        return function(m, o) {
          return g(m), u(o), A ? S(m, o) : m.__proto__ = o, m;
        };
      })() : void 0);
    })
  ),
  ...
  2923: (
    ...
    ((w, D, t) => {
      ...
      w.exports = function(b, S) {
        var p, m;
        if (S === "string" && g(p = b.toString) && !u(m = s(p, b)) || g(p = b.valueOf) && !u(m = s(p, b)) || S !== "string" && g(p = b.toString) && !u(m = s(p, b)))
          return m;
  ...
  8953: (
    /***/
    ((w, D, t) => {
      var s = t(7187), g = t(8403), u = t(5455), A = t(1963), b = t(4719), S = g([].concat);
  ...
  3713: (
    /***/
    ((w, D, t) => {
      var s = t(8403), g = t(936), u = SyntaxError, A = parseInt, b = String.fromCharCode, S = s("".charAt), p = s("".slice), m = s(/./.exec), o = {
        '\\"': '"',
        "\\\\": "\\",
        "\\/": "/",
        "\\b": "\b",
...
`,
  ...
  5656: (
    /***/
    ((w, D, t) => {
      var s = t(5690), g = t(23), u = t(4057), A = t(6098), b = t(1096), S = t(8848), p = t(5504), m = g.has, o = g.remove;
      w.exports = function(c) {
        var r = s(this), f = b(c), e = u(r);
        return A(r) <= f.size ? S(r, function(i) {
          f.includes(i) && o(e, i);
  ...
  8461: (
    /***/
    ((w, D, t) => {
      var s = t(5690), g = t(23), u = t(6098), A = t(1096), b = t(8848), S = t(5504), p = g.Set, m = g.add, o = g.has;
      w.exports = function(c) {
        var r = s(this), f = A(c), e = new p();
        return u(r) > f.size ? S(f.getIterator(), function(i) {
          o(r, i) && m(e, i);
        }) : b(r, function(i) {
          f.includes(i) && m(e, i);
        }), e;
  ...
  8550: (
    /***/
    ((w, D, t) => {
      var s = t(5690), g = t(23).has, u = t(6098), A = t(1096), b = t(8848), S = t(5504), p = t(3316);
      w.exports = function(o) {
        var l = s(this), c = A(o);
        if (u(l) <= c.size)
  ...
  194: (
    /***/
    ((w, D, t) => {
      var s = t(5690), g = t(23).has, u = t(6098), A = t(1096), b = t(5504), S = t(3316);
  ...
  8848: (
    /***/
    ((w, D, t) => {
      var s = t(8403), g = t(5504), u = t(23), A = u.Set, b = u.proto, S = s(b.forEach), p = s(b.keys), m = p(new A()).next;
  ...
  3194: (
    /***/
    ((w, D, t) => {
      var s = t(5690), g = t(23), u = t(4057), A = t(1096), b = t(5504), S = g.add, p = g.has, m = g.remove;
  ...
  4837: (
    /***/
    ((w, D, t) => {
      var s = t(9298), g = t(8154), u = t(2171), A = t(3413), b = t(8471), S = t(4864), p = s.structuredClone;
      w.exports = !!p && !g(function() {
        if (b && u > 92 || S && u > 94 || A && u > 97)
          return !1;
  ...
  4151: (
    /***/
    ((w, D, t) => {
      var s = t(2026), g = t(7633), u = t(7814), A = t(8486), b = t(2923), S = t(2292), p = TypeError, m = S("toPrimitive");
  ...
  2292: (
    /***/
    ((w, D, t) => {
      var s = t(9298), g = t(6807), u = t(936), A = t(7561), b = t(3663), S = t(7960), p = s.Symbol, m = g("wks"), o = S ? p.for || p : p && p.withoutSetter || A;
      w.exports = function(l) {
  ...
  7342: (
    /***/
    ((w, D, t) => {
      var s = t(7187), g = t(936), u = t(9293), A = t(2658), b = t(9763), S = t(1425), p = t(6085), m = t(7523), o = t(1264), l = t(8422), c = t(1931), r = t(940), f = t(2554);
      w.exports = function(e, i, y, T) {
        ...
        if ($) {
          ...
          if (Q.prototype = j, M !== "Error" ? b ? b(Q, K) : S(Q, K, { name: !0 }) : r && E in $ && (p(Q, $, E), p(Q, $, "prepareStackTrace")), S(Q, $), !f)
            try {
  ...
  4226: (
    /***/
    ((w, D, t) => {
      var s = t(4978), g = t(2007), u = t(451), A = t(6661), b = t(4287), S = t(8154), p = S(function() {
  ...
  3352: (
    /***/
    ((w, D, t) => {
      var s = t(4978), g = t(9298), u = t(7294), A = t(7342), b = "WebAssembly", S = g[b], p = new Error("e", { cause: 7 }).cause !== 7, m = function(l, c) {
        var r = {};
        r[l] = A(l, c, p), s({
          global: !0,
          constructor: !0,
  ...
  9803: (
    ...
    ((w, D, t) => {
      ...
      A("findLastIndex", function(S) {
        return g(u(this), S, arguments.length > 1 ? arguments[1] : void 0);
      });
    })
  ),
  /***/
  ...
  8347: (
    /***/
    ((w, D, t) => {
      var s = t(9298), g = t(2026), u = t(5861), A = t(451), b = t(9892), S = t(2007), p = t(8154), m = s.RangeError, o = s.Int8Array, l = o && o.prototype, c = l && l.set, r = u.aTypedArray, f = u.exportTypedArrayMethod, e = !p(function() {
      ...
      f("set", function(T) {
        r(this);
        var E = b(arguments.length > 1 ? arguments[1] : void 0, 1), R = S(T);
        if (e)
          return g(c, this, R, E);
  ...
  62: (
    /***/
    ((w, D, t) => {
      var s = t(5861), g = t(8403), u = t(1782), A = t(7003), b = s.aTypedArray, S = s.getTypedArrayConstructor, p = s.exportTypedArrayMethod, m = g(s.TypedArrayPrototype.sort);
      p("toSorted", function(l) {
        l !== void 0 && u(l);
        var c = b(this), r = A(S(c), c);
        return m(r, l);
      });
    })
  ),
  ...
  4602: (
    /***/
    ((w, D, t) => {
      var s = t(5886), g = t(5861), u = t(5986), A = t(1003), b = t(212), S = g.aTypedArray, p = g.getTypedArrayConstructor, m = g.exportTypedArrayMethod, o = !!(function() {
        try {
      ...
      m("with", function(l, c) {
        var r = S(this), f = A(l), e = u(r) ? b(c) : +c;
        return s(r, p(r), f, e);
      }, !o);
    })
  ),
  ...
  7121: (
    /***/
    ((w, D, t) => {
      var s = t(4978), g = t(9298), u = t(5834), A = t(4719), b = t(7316), S = t(2176), p = t(9691), m = t(8947), o = t(8154), l = t(936), c = t(2292), r = t(5238).IteratorPrototype, f = t(940), e = t(2554), i = "constructor", y = "Iterator", T = c("toStringTag"), E = TypeError, R = g[y], L = e || !b(R) || R.prototype !== r || !o(function() {
        R({});
      }), M = function() {
        if (u(this, r), S(this) === r)
  ...
  2993: (
    /***/
    ((w, D, t) => {
      var s = t(4978), g = t(2026), u = t(1782), A = t(4719), b = t(9235), S = t(375), p = t(5723), m = t(2554), o = S(function() {
  ...
  8497: (
    /***/
    ((w, D, t) => {
      var s = t(4978), g = t(2026), u = t(1782), A = t(4719), b = t(9235), S = t(907), p = t(375), m = t(3316), o = t(2554), l = p(function() {
        for (var c = this.iterator, r = this.mapper, f, e; ; ) {
          ...
          if (f = A(g(this.next, c)), this.done = !!f.done)
            return;
          try {
            this.inner = S(r(f.value, this.counter++), !1);
          } catch (i) {
            m(c, "throw", i);
          }
        }
  ...
  2808: (
    /***/
    ((w, D, t) => {
      var s = t(4978), g = t(940), u = t(9298), A = t(7187), b = t(8403), S = t(2026), p = t(7316), m = t(7633), o = t(6998), l = t(936), c = t(5730), r = t(451), f = t(8947), e = t(8154), i = t(3713), y = t(3663), T = u.JSON, E = u.Number, R = u.SyntaxError, L = T && T.parse, M = A("Object", "keys"), $ = Object.getOwnPropertyDescriptor, j = b("".charAt), K = b("".slice), Q = b(/./.exec), J = b([].push), at = /^\d$/, ut = /^[1-9]$/, ht = /^(?:-|\d)$/, _ = /^[\t\n\r ]$/, Z = 0, z = 1, V = function(tt, v) {
        tt = c(tt);
        ...
        var a = tt[v], d = n && a === n.value, x = d && typeof n.source == "string" ? { source: n.source } : {}, C, P, F, O, N;
        if (m(a)) {
      ...
      vt.prototype = {
        ...
        object: function() {
          for (var tt = this.source, v = this.index + 1, h = !1, n = {}, a = {}; v < tt.length; ) {
            ...
            var d = this.fork(v).string(), x = d.value;
            v = d.end, v = this.until([":"], v) + 1, v = this.skip(_, v), d = this.fork(v).parse(), f(a, x, d), f(n, x, d.value), v = this.until([
              ",",
              "}"
            ], d.end);
            var C = j(tt, v);
  ...
  9709: (
    /***/
    ((w, D, t) => {
      var s = t(4978), g = t(9298), u = t(7187), A = t(1198), b = t(7744).f, S = t(936), p = t(5834), m = t(7523), o = t(1264), l = t(5050), c = t(34), r = t(940), f = t(2554), e = "DOMException", i = u("Error"), y = u(e), T = function() {
        p(this, E);
  ...
  3655: (
    /***/
    ((w, D, t) => {
      var s = t(7041), g = t(8403), u = t(5730), A = t(2743), b = URLSearchParams, S = b.prototype, p = g(S.append), m = g(S.delete), o = g(S.forEach), l = g([].push), c = new b("a=1&a=2&b=3");
      c.delete("a", 1), c.delete("b", void 0), c + "" != "a=2" && s(S, "delete", function(r) {
  ...
  2555: (
    /***/
    ((w, D, t) => {
      var s = t(7041), g = t(8403), u = t(5730), A = t(2743), b = URLSearchParams, S = b.prototype, p = g(S.getAll), m = g(S.has), o = new b("a=1");
      (o.has("a", 2) || !o.has("a", void 0)) && s(S, "has", function(c) {
  ...
  7640: (
    ...
    ((w, D, t) => {
      ...
      class S {
        ...
        static RGB_CMYK(v) {
          let [h, n, a] = v;
          const d = 1 - h, x = 1 - n, C = 1 - a, P = Math.min(d, x, C);
          return ["CMYK", d, x, C, P];
        }
      }
      var p = t(8266);
      ...
      class f {
        ...
        _createContainer(v) {
          ...
          d.style.left = `${100 * (k[0] - P) / x}%`, d.style.top = `${100 * (k[1] - F) / C}%`;
          const {
            rotation: U
          } = h;
          return h.hasOwnCanvas || U === 0 ? (d.style.width = `${100 * O / x}%`, d.style.height = `${100 * N / C}%`) : this.setRotation(U, d), d;
        }
        setRotation(v) {
          ...
          let C, P;
          v % 180 === 0 ? (C = 100 * d / n, P = 100 * x / a) : (C = 100 * x / n, P = 100 * d / a), h.style.width = `${C}%`, h.style.height = `${P}%`, h.setAttribute("data-main-rotation", (360 - v) % 360);
        }
        get _commonActions() {
          const v = (h, n, a) => {
            const d = a.detail[h], x = d[0], C = d.slice(1);
            a.target.style[n] = S[`${x}_HTML`](C), this.annotationStorage.setValue(this.data.id, {
              [n]: S[`${x}_rgb`](C)
            });
          };
        ...
        _createQuadrilaterals() {
          ...
          if (this.#t) {
            ...
            x.borderWidth = 0, C = ["url('data:image/svg+xml;utf8,", '<svg xmlns="http://www.w3.org/2000/svg"', ' preserveAspectRatio="none" viewBox="0 0 1 1">', `<g fill="transparent" stroke="${G}" stroke-width="${I}">`], this.container.classList.add("hasBorder");
          }
          const P = a - h, F = d - n, {
            svgFactory: O
          ...
          this.#t && (C.push("</g></svg>')"), x.backgroundImage = C.join("")), this.container.append(N), this.container.style.clipPath = `url(#${Y})`;
        }
        _createPopup() {
          const {
            container: v,
        ...
        _getElementsByName(v) {
          ...
          if (this._fieldObjects) {
            ...
            if (a)
              for (const {
                ...
                if (d === -1 || x === h)
                  continue;
                const P = typeof C == "string" ? C : null, F = document.querySelector(`[data-element-id="${x}"]`);
                if (F && !l.has(F)) {
                  (0, s.warn)(`_getElementsByName - element not allowed: ${x}`);
                  continue;
                }
                n.push({
                  id: x,
          ...
          for (const a of document.getElementsByName(v)) {
            const {
              exportValue: d
            } = a, x = a.getAttribute("data-element-id");
            x !== h && l.has(a) && n.push({
              id: x,
              exportValue: d,
              domElement: a
      ...
      class y extends f {
        ...
        _setEventListener(v, h, n, a, d) {
          n.includes("mouse") ? v.addEventListener(n, (x) => {
            this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
              ...
              detail: {
                ...
                value: d(x),
                shift: x.shiftKey,
                modifier: this._getKeyModifier(x)
              }
            });
          }) : v.addEventListener(n, (x) => {
            if (n === "blur") {
              if (!h.focused || !x.relatedTarget)
                return;
              h.focused = !1;
            } else if (n === "focus") {
              if (h.focused)
        ...
        _setEventListeners(v, h, n, a) {
          for (const [d, x] of n)
            (x === "Action" || this.data.actions?.[x]) && ((x === "Focus" || x === "Blur") && (h ||= {
              focused: !1
            }), this._setEventListener(v, h, d, x, a), x === "Focus" && !this.data.actions?.Blur ? this._setEventListener(v, h, "blur", "Blur", null) : x === "Blur" && !this.data.actions?.Focus && this._setEventListener(v, h, "focus", "Focus", null));
        }
        ...
        _setTextStyle(v) {
          ...
          if (this.data.multiLine) {
            ...
            x = Math.min(a, P(N / s.LINE_FACTOR));
          } else {
            const F = Math.abs(this.data.rect[3] - this.data.rect[1] - C);
            x = Math.min(a, P(F / s.LINE_FACTOR));
          }
          d.fontSize = `calc(${x}px * var(--scale-factor))`, d.color = s.Util.makeHexColor(n[0], n[1], n[2]), this.data.textAlignment !== null && (d.textAlign = h[this.data.textAlignment]);
        }
        _setRequired(v, h) {
      ...
      class T extends y {
        ...
        setPropertyOnSiblings(v, h, n, a) {
          ...
          for (const x of this._getElementsByName(v.name, v.id))
            x.domElement && (x.domElement[h] = n), d.setValue(x.id, {
              [a]: n
            });
        }
        render() {
          ...
          if (this.renderForms) {
            ...
            let d = a.value || "";
            const x = v.getValue(h, {
              charLimit: this.data.maxLen
            }).charLimit;
            x && d.length > x && (d = d.slice(0, x));
...
`) || null;
            ...
            this.data.multiLine ? (n = document.createElement("textarea"), n.textContent = C ?? d, this.data.doNotScroll && (n.style.overflowY = "hidden")) : (n = document.createElement("input"), n.type = "text", n.setAttribute("value", C ?? d), this.data.doNotScroll && (n.style.overflowX = "hidden")), this.data.hasOwnCanvas && (n.hidden = !0), l.add(n), n.setAttribute("data-element-id", h), n.disabled = this.data.readOnly, n.name = this.data.fieldName, n.tabIndex = m, this._setRequired(n, this.data.required), x && (n.maxLength = x), n.addEventListener("input", (O) => {
              v.setValue(h, {
            ...
            if (F && n.addEventListener("blur", F), this.data.comb) {
              const N = (this.data.rect[2] - this.data.rect[0]) / x;
      ...
      class R extends y {
        ...
        render() {
          ...
          return l.add(d), d.setAttribute("data-element-id", n), d.disabled = h.readOnly, this._setRequired(d, this.data.required), d.type = "checkbox", d.name = h.fieldName, a && d.setAttribute("checked", !0), d.setAttribute("exportValue", h.exportValue), d.tabIndex = m, d.addEventListener("change", (x) => {
            const {
              name: C,
              checked: P
            } = x.target;
          ...
          }), d.addEventListener("resetform", (x) => {
            const C = h.defaultFieldValue || "Off";
            x.target.checked = C === h.exportValue;
          }), this.enableScripting && this.hasJSActions && (d.addEventListener("updatefromsandbox", (x) => {
            const C = {
              value(P) {
            ...
            this._dispatchEventFromSandbox(C, x);
          }), this._setEventListeners(d, null, [["change", "Validate"], ["change", "Action"], ["focus", "Focus"], ["blur", "Blur"], ["mousedown", "Mouse Down"], ["mouseenter", "Mouse Enter"], ["mouseleave", "Mouse Exit"], ["mouseup", "Mouse Up"]], (x) => x.target.checked)), this._setBackgroundColor(d), this._setDefaultPropertiesFromJS(d), this.container.append(d), this.container;
        }
      }
      class L extends y {
        constructor(v) {
        ...
        render() {
          ...
          if (typeof a == "string" && (a = a !== h.buttonValue, v.setValue(n, {
            ...
            for (const x of this._getElementsByName(h.fieldName, n))
              v.setValue(x.id, {
                value: !1
              });
          const d = document.createElement("input");
          if (l.add(d), d.setAttribute("data-element-id", n), d.disabled = h.readOnly, this._setRequired(d, this.data.required), d.type = "radio", d.name = h.fieldName, a && d.setAttribute("checked", !0), d.tabIndex = m, d.addEventListener("change", (x) => {
            const {
              name: C,
              checked: P
            } = x.target;
            ...
            x.target.checked = C != null && C === h.buttonValue;
          }), this.enableScripting && this.hasJSActions) {
            const x = h.buttonValue;
            d.addEventListener("updatefromsandbox", (C) => {
              const P = {
                value: (F) => {
                  const O = x === F.detail.value;
      ...
      class $ extends y {
        ...
        render() {
          ...
          if (d) {
            ...
            O.value = " ", O.setAttribute("hidden", !0), O.setAttribute("selected", !0), a.prepend(O), x = () => {
              O.remove(), a.removeEventListener("input", x), x = null;
            }, a.addEventListener("input", x);
          }
          const C = (O) => {
      ...
      class K {
        ...
        constructor(v) {
          ...
          this.#i = h, this.#m = d, this.#o = C, this.#p = P, this.#c = F, this.#r = n, this.#a = O, this.#f = N, this.#h = a, this.#l = g.PDFDateString.toDateObject(x), this.trigger = a.flatMap((U) => U.getElementsToTriggerPopup());
        ...
        render() {
          ...
          } = this.#c, x = this.#d = document.createElement("div");
          if (x.className = "popup", this.#r) {
            const q = x.style.outlineColor = s.Util.makeHexColor(...this.#r);
            CSS.supports("background-color", "color-mix(in srgb, red 30%, white)") ? x.style.backgroundColor = `color-mix(in srgb, ${q} 30%, white)` : x.style.backgroundColor = s.Util.makeHexColor(...this.#r.map((pt) => Math.floor(0.7 * (255 - pt) + pt)));
          }
          ...
          if (O?.str && (!F?.str || F.str === O.str))
            p.XfaLayer.render({
              ...
              intent: "richText",
              div: x
            }), x.lastChild.classList.add("richText", "popupContent");
          else {
          ...
          st.left = `${100 * (I - a) / h}%`, st.top = `${100 * (B - d) / n}%`, this.#i.append(x);
        }
        _formatContents(v) {
          let {
            str: h,
          ...
          for (let x = 0, C = d.length; x < C; ++x) {
            const P = d[x];
            a.append(document.createTextNode(P)), x < C - 1 && a.append(document.createElement("br"));
          }
          return a;
        }
        #y(v) {
      ...
      class at extends f {
        ...
        render() {
          ...
          const v = this.data, {
            width: h,
            height: n
          } = c(v.rect), a = this.svgFactory.create(h, n, !0), d = v.borderStyle.width, x = this.#t = this.svgFactory.createElement("svg:rect");
          return x.setAttribute("x", d / 2), x.setAttribute("y", d / 2), x.setAttribute("width", h - d), x.setAttribute("height", n - d), x.setAttribute("stroke-width", d || 1), x.setAttribute("stroke", "transparent"), x.setAttribute("fill", "transparent"), a.append(x), this.container.append(a), !v.popupRef && this.hasPopupData && this._createPopup(), this.container;
        }
        getElementsToTriggerPopup() {
          return this.#t;
        }
      ...
      class ut extends f {
        ...
        render() {
          ...
          const v = this.data, {
            width: h,
            height: n
          } = c(v.rect), a = this.svgFactory.create(h, n, !0), d = v.borderStyle.width, x = this.#t = this.svgFactory.createElement("svg:ellipse");
          return x.setAttribute("cx", h / 2), x.setAttribute("cy", n / 2), x.setAttribute("rx", h / 2 - d / 2), x.setAttribute("ry", n / 2 - d / 2), x.setAttribute("stroke-width", d || 1), x.setAttribute("stroke", "transparent"), x.setAttribute("fill", "transparent"), a.append(x), this.container.append(a), !v.popupRef && this.hasPopupData && this._createPopup(), this.container;
        }
        getElementsToTriggerPopup() {
          return this.#t;
        }
      ...
      class ht extends f {
        ...
        render() {
          ...
          d = d.join(" ");
          const x = this.#t = this.svgFactory.createElement(this.svgElementName);
          return x.setAttribute("points", d), x.setAttribute("stroke-width", v.borderStyle.width || 1), x.setAttribute("stroke", "transparent"), x.setAttribute("fill", "transparent"), a.append(x), this.container.append(a), !v.popupRef && this.hasPopupData && this._createPopup(), this.container;
        }
        getElementsToTriggerPopup() {
          return this.#t;
        }
      ...
      class z extends f {
        ...
        render() {
          ...
          for (const d of v.inkLists) {
            ...
            this.#t.push(C), C.setAttribute("points", x), C.setAttribute("stroke-width", v.borderStyle.width || 1), C.setAttribute("stroke", "transparent"), C.setAttribute("fill", "transparent"), !v.popupRef && this.hasPopupData && this._createPopup(), a.append(C);
          }
      ...
      class xt {
        ...
        constructor(v) {
          ...
          this.div = h, this.#t = n, this.#e = a, this.page = d, this.viewport = x, this.zIndex = 0;
        }
        #s(v, h) {
        ...
        async render(v) {
          ...
          for (const x of h) {
            if (x.noHTML)
              continue;
            const C = x.annotationType === s.AnnotationType.POPUP;
            if (C) {
              const O = a.get(x.id);
              if (!O)
                continue;
            ...
            if (!P.isRenderable)
              continue;
            if (!C && x.popupRef) {
              const O = a.get(x.popupRef);
              O ? O.push(P) : a.set(x.popupRef, [P]);
            }
            P.annotationEditorType > 0 && this.#n.set(P.data.id, P);
            const F = P.render();
            x.hidden && (F.style.visibility = "hidden"), this.#s(F, x.id);
          }
          this.#r();
        }
        update(v) {
    ...
    ((w, D, t) => {
      t.a(w, async (s, g) => {
        try {
            ...
            return Ct.promise.then(function() {
              ...
              const Bt = O(Ct, ae), le = new Promise(function(Xt) {
                ...
                Et ? Ht = new lt.PDFDataTransportStream({
                  ...
                  disableRange: Kt,
                  disableStream: Jt
                }, Et) : rt || (Ht = ((Ot) => J.isNodeJS ? new xt.PDFNodeStream(Ot) : (0, ut.isValidFetchUrl)(Ot.url) ? new vt.PDFFetchStream(Ot) : new Tt.PDFNetworkStream(Ot))({
                  url: X,
                  length: $t,
                  httpHeaders: it,
                  withCredentials: dt,
          ...
          var u = t(3655), A = t(2555), b = t(2202), S = t(3352), p = t(8837), m = t(9803), o = t(8347), l = t(7995), c = t(62), r = t(4602), f = t(344), e = t(4305), i = t(7583), y = t(4226), T = t(5561), E = t(8587), R = t(3247), L = t(3302), M = t(9490), $ = t(5438), j = t(7914), K = t(7944), Q = t(9709), J = t(3266), at = t(4780), ut = t(473), ht = t(3742), _ = t(7738), Z = t(1250), z = t(1368), V = t(6694), nt = t(3472), ot = t(3890), lt = t(4092), vt = t(5171), Tt = t(3474), xt = t(3498), tt = t(1521), v = s([_, xt]);
          [_, xt] = v.then ? (await v)() : v;
          const h = 65536, n = 100, a = 5e3, d = J.isNodeJS ? _.NodeCanvasFactory : ut.DOMCanvasFactory, x = J.isNodeJS ? _.NodeCMapReaderFactory : ut.DOMCMapReaderFactory, C = J.isNodeJS ? _.NodeFilterFactory : ut.DOMFilterFactory, P = J.isNodeJS ? _.NodeStandardFontDataFactory : ut.DOMStandardFontDataFactory;
          ...
          class I {
              ...
              return new Promise(function(X, rt) {
                function it() {
                  dt.read().then(function(Et) {
                    ...
                    Object.assign(gt.styles, St.styles), gt.items.push(...St.items), it();
                  }, rt);
                }
            ...
            _pumpOperatorList(H) {
              ...
              }, dt).getReader(), St = this._intentStates.get(X);
              St.streamReader = Et;
              const Ct = () => {
                Et.read().then((wt) => {
                  let {
              ...
              H.on("GetReader", (X, rt) => {
                ...
                switch (it) {
                  case "Font":
                    ...
                    const Et = gt.pdfBug && globalThis.FontInspector?.enabled ? (wt, Pt) => globalThis.FontInspector.fontAdded(wt, Pt) : null, St = new ht.FontFaceObject(dt, {
                      isEvalSupported: gt.isEvalSupported,
                      disableFontFace: gt.disableFontFace,
                      ignoreErrors: gt.ignoreErrors,
                      inspectFont: Et
                    });
                    this.fontLoader.bind(St).catch((wt) => H.sendWithPromise("FontFallback", {
                      id: rt
                    })).finally(() => {
                      !gt.fontExtraProperties && St.data && (St.data = null), this.commonObjs.resolve(rt, St);
                    });
                    break;
                  case "CopyLocalImage":
                    const {
          ...
          class mt {
            ...
            constructor(H) {
              ...
              this.callback = W, this.params = X, this.objs = rt, this.commonObjs = it, this.annotationCanvasMap = dt, this.operatorListIdx = null, this.operatorList = gt, this._pageIndex = Et, this.canvasFactory = St, this.filterFactory = Ct, this._pdfBug = Pt, this.pageColors = Rt, this.running = !1, this.graphicsReadyCallback = null, this.graphicsReady = !1, this._useRequestAnimationFrame = wt === !0 && typeof window < "u", this.cancelled = !1, this.capability = new J.PromiseCapability(), this.task = new ft(this), this._cancelBound = this.cancel.bind(this), this._continueBound = this._continue.bind(this), this._scheduleNextBound = this._scheduleNext.bind(this), this._nextBound = this._next.bind(this), this._canvas = X.canvasContext.canvas;
            }
            get completed() {
  ...
  6822: (
    ...
    ((w, D, t) => {
      ...
      class S {
        constructor() {
          this.constructor === S && (0, s.unreachable)("Cannot initialize BaseSVGFactory.");
        }
        create(m, o) {
  ...
  1250: (
    ...
    ((w, D, t) => {
      ...
      function A(h, n) {
        if (!n)
          return;
        const a = n[2] - n[0], d = n[3] - n[1], x = new Path2D();
        x.rect(n[0], n[1], a, d), h.clip(x);
      }
      class b {
        constructor() {
      ...
      class S extends b {
        ...
        getPattern(n, a, d, x) {
          let C;
          if (x === u.STROKE || x === u.FILL) {
            const P = a.current.getClippedPathBoundingBox(x, (0, g.getCurrentTransform)(n)) || [0, 0, 0, 0], F = Math.ceil(P[2] - P[0]) || 1, O = Math.ceil(P[3] - P[1]) || 1, N = a.cachedCanvases.getCanvas("pattern", F, O, !0), k = N.context;
      ...
      function p(h, n, a, d, x, C, P, F) {
        const O = n.coords, N = n.colors, k = h.data, U = h.width * 4;
        let Y;
        O[a + 1] > O[d + 1] && (Y = a, a = d, d = Y, Y = C, C = P, P = Y), O[d + 1] > O[x + 1] && (Y = d, d = x, x = Y, Y = P, P = F, F = Y), O[a + 1] > O[d + 1] && (Y = a, a = d, d = Y, Y = C, C = P, P = Y);
        const G = (O[a] + n.offsetX) * n.scaleX, I = (O[a + 1] + n.offsetY) * n.scaleY, B = (O[d] + n.offsetX) * n.scaleX, st = (O[d + 1] + n.offsetY) * n.scaleY, q = (O[x] + n.offsetX) * n.scaleX, ct = (O[x + 1] + n.offsetY) * n.scaleY;
        if (I >= ct)
          return;
        const pt = N[C], ft = N[C + 1], mt = N[C + 2], yt = N[P], At = N[P + 1], et = N[P + 2], H = N[F], W = N[F + 1], X = N[F + 2], rt = Math.round(I), it = Math.round(ct);
        let dt, gt, Et, St, Ct, wt, Pt, Rt;
        for (let Mt = rt; Mt <= it; Mt++) {
          if (Mt < st) {
            const Ft = Mt < I ? 0 : (I - Mt) / (I - st);
            dt = G - (G - B) * Ft, gt = pt - (pt - yt) * Ft, Et = ft - (ft - At) * Ft, St = mt - (mt - et) * Ft;
          } else {
            let Ft;
            Mt > ct ? Ft = 1 : st === ct ? Ft = 0 : Ft = (st - Mt) / (st - ct), dt = B - (B - q) * Ft, gt = yt - (yt - H) * Ft, Et = At - (At - W) * Ft, St = et - (et - X) * Ft;
          }
          let It;
          ...
          for (let Ft = Lt; Ft <= Nt; Ft++)
            It = (dt - Ft) / (dt - Ct), It < 0 ? It = 0 : It > 1 && (It = 1), k[Dt++] = gt - (gt - wt) * It | 0, k[Dt++] = Et - (Et - Pt) * It | 0, k[Dt++] = St - (St - Rt) * It | 0, k[Dt++] = 255;
        }
      }
      function m(h, n, a) {
        const d = n.coords, x = n.colors;
        let C, P;
        switch (n.type) {
          case "lattice":
            ...
            for (C = 0; C < O; C++) {
              let k = C * F;
              for (let U = 0; U < N; U++, k++)
                p(h, a, d[k], d[k + 1], d[k + F], x[k], x[k + 1], x[k + F]), p(h, a, d[k + F + 1], d[k + 1], d[k + F], x[k + F + 1], x[k + 1], x[k + F]);
            }
            break;
          case "triangles":
            for (C = 0, P = d.length; C < P; C += 3)
              p(h, a, d[C], d[C + 1], d[C + 2], x[C], x[C + 1], x[C + 2]);
            break;
          default:
      ...
      class o extends b {
        ...
        getPattern(n, a, d, x) {
          ...
          const P = this._createMeshCanvas(C, x === u.SHADING ? null : this._background, a.cachedCanvases);
          return x !== u.SHADING && (n.setTransform(...a.baseTransform), this.matrix && n.transform(...this.matrix)), n.translate(P.offsetX, P.offsetY), n.scale(P.scaleX, P.scaleY), n.createPattern(P.canvas, "no-repeat");
        }
      }
      class l extends b {
        getPattern() {
      ...
      class f {
        ...
        constructor(n, a, d, x, C) {
          this.operatorList = n[2], this.matrix = n[3] || [1, 0, 0, 1, 0, 0], this.bbox = n[4], this.xstep = n[5], this.ystep = n[6], this.paintType = n[7], this.tilingType = n[8], this.color = a, this.ctx = d, this.canvasGraphicsFactory = x, this.baseTransform = C;
        }
        createPatternCanvas(n) {
          const a = this.operatorList, d = this.bbox, x = this.xstep, C = this.ystep, P = this.paintType, F = this.tilingType, O = this.color, N = this.canvasGraphicsFactory;
          (0, s.info)("TilingType: " + F);
          const k = d[0], U = d[1], Y = d[2], G = d[3], I = s.Util.singularValueDecompose2dScale(this.matrix), B = s.Util.singularValueDecompose2dScale(this.baseTransform), st = [I[0] * B[0], I[1] * B[1]], q = this.getSizeAndScale(x, this.ctx.canvas.width, st[0]), ct = this.getSizeAndScale(C, this.ctx.canvas.height, st[1]), pt = n.cachedCanvases.getCanvas("pattern", q.size, ct.size, !0), ft = pt.context, mt = N.createCanvasGraphics(ft);
        ...
        getSizeAndScale(n, a, d) {
          n = Math.abs(n);
          const x = Math.max(f.MAX_PATTERN_SIZE, a);
          let C = Math.ceil(n * d);
          return C >= x ? C = x : d = C / n, {
            scale: d,
            size: C
          };
        }
        clipBbox(n, a, d, x, C) {
          const P = x - a, F = C - d;
          n.ctx.rect(a, d, P, F), n.current.updateRectMinMax((0, g.getCurrentTransform)(n.ctx), [a, d, x, C]), n.clip(), n.endPath();
        }
        setFillAndStrokeStyleToContext(n, a, d) {
          const x = n.ctx, C = n.current;
          switch (a) {
            case r.COLORED:
              const P = this.ctx;
              x.fillStyle = P.fillStyle, x.strokeStyle = P.strokeStyle, C.fillColor = P.fillStyle, C.strokeColor = P.strokeStyle;
              break;
            case r.UNCOLORED:
              const F = s.Util.makeHexColor(d[0], d[1], d[2]);
              x.fillStyle = F, x.strokeStyle = F, C.fillColor = F, C.strokeColor = F;
              break;
            default:
        ...
        getPattern(n, a, d, x) {
          let C = d;
          x !== u.SHADING && (C = s.Util.transform(C, a.baseTransform), this.matrix && (C = s.Util.transform(C, this.matrix)));
      ...
      function e(h) {
        ...
        const O = s.FeatureTest.isLittleEndian ? 4278190080 : 255, [N, k] = F ? [P, O] : [O, P], U = x >> 3, Y = x & 7, G = n.length;
      ...
      function $(h, n) {
        ...
        }, h.translate = function(d, x) {
          n.translate(d, x), this.__originalTranslate(d, x);
        }, h.scale = function(d, x) {
          n.scale(d, x), this.__originalScale(d, x);
        }, h.transform = function(d, x, C, P, F, O) {
          n.transform(d, x, C, P, F, O), this.__originalTransform(d, x, C, P, F, O);
        }, h.setTransform = function(d, x, C, P, F, O) {
          n.setTransform(d, x, C, P, F, O), this.__originalSetTransform(d, x, C, P, F, O);
        ...
        }, h.bezierCurveTo = function(a, d, x, C, P, F) {
          n.bezierCurveTo(a, d, x, C, P, F), this.__originalBezierCurveTo(a, d, x, C, P, F);
        }, h.rect = function(a, d, x, C) {
          n.rect(a, d, x, C), this.__originalRect(a, d, x, C);
      ...
      class j {
        ...
        getCanvas(n, a, d) {
          let x;
          return this.cache[n] !== void 0 ? (x = this.cache[n], this.canvasFactory.reset(x, a, d)) : (x = this.canvasFactory.create(a, d), this.cache[n] = x), x;
        }
        delete(n) {
          delete this.cache[n];
        }
      ...
      function K(h, n, a, d, x, C, P, F, O, N) {
        ...
        if (U === 0 && Y === 0) {
          ...
          return h.setTransform(Math.sign(k), 0, 0, Math.sign(G), pt, mt), h.drawImage(n, a, d, x, C, 0, 0, At, H), h.setTransform(k, U, Y, G, I, B), [At, H];
        }
        if (k === 0 && G === 0) {
          ...
          return h.setTransform(0, Math.sign(U), Math.sign(Y), 0, pt, mt), h.drawImage(n, a, d, x, C, 0, 0, H, At), h.setTransform(k, U, Y, G, I, B), [H, At];
        }
        h.drawImage(n, a, d, x, C, P, F, O, N);
      ...
      function Q(h) {
        ...
        if (n > L || a > L)
          return null;
        const d = 1e3, x = new Uint8Array([0, 2, 4, 0, 1, 0, 5, 4, 8, 10, 0, 8, 0, 2, 1, 0]), C = n + 1;
        ...
        for (U[Y] !== 0 && (P[O] = 2, ++G), F = 1; F < a; F++) {
          ...
          for (O = 1; O < n; O++)
            q = (q >> 2) + (U[Y + 1] ? 4 : 0) + (U[Y - k + 1] ? 8 : 0), x[q] && (P[N + O] = x[q], ++G), Y++;
      ...
      class J {
        ...
        updateRectMinMax(n, a) {
          const d = s.Util.applyTransform(a, n), x = s.Util.applyTransform(a.slice(2), n), C = s.Util.applyTransform([a[0], a[3]], n), P = s.Util.applyTransform([a[2], a[1]], n);
          this.minX = Math.min(this.minX, d[0], x[0], C[0], P[0]), this.minY = Math.min(this.minY, d[1], x[1], C[1], P[1]), this.maxX = Math.max(this.maxX, d[0], x[0], C[0], P[0]), this.maxY = Math.max(this.maxY, d[1], x[1], C[1], P[1]);
        }
        ...
        updateCurvePathMinMax(n, a, d, x, C, P, F, O, N, k) {
          const U = s.Util.bezierBoundingBox(a, d, x, C, P, F, O, N);
          if (k) {
        ...
        getPathBoundingBox() {
          ...
          if (n === u.STROKE) {
            ...
            const x = s.Util.singularValueDecompose2dScale(a), C = x[0] * this.lineWidth / 2, P = x[1] * this.lineWidth / 2;
      ...
      function at(h, n) {
        ...
        const a = n.height, d = n.width, x = a % M, C = (a - x) / M, P = x === 0 ? C : C + 1, F = h.createImageData(d, M);
        let O = 0, N;
        ...
        if (n.kind === s.ImageKind.GRAYSCALE_1BPP) {
          ...
          Y < P && (B = d * x * 4, U.set(k.subarray(O, O + B)), h.putImageData(F, 0, G));
        } else if (n.kind === s.ImageKind.RGB_24BPP)
          for (I = M, B = d * I, Y = 0; Y < P; Y++) {
            for (Y >= C && (I = x, B = d * I), N = 0, G = B; G--; )
      ...
      function V(h, n, a) {
        const d = h.length;
        for (let x = 3; x < d; x += 4) {
          const C = h[x - 3] * 77 + h[x - 2] * 152 + h[x - 1] * 28;
          n[x] = a ? n[x] * a[C >> 8] >> 8 : n[x] * C >> 16;
        }
      }
      function nt(h, n, a, d, x, C, P, F, O, N, k) {
        const U = !!C, Y = U ? C[0] : 0, G = U ? C[1] : 0, I = U ? C[2] : 0, B = x === "Luminosity" ? V : z, q = Math.min(d, Math.ceil(1048576 / a));
      ...
      function ot(h, n, a, d) {
        const x = d[0], C = d[1], P = d[2] - x, F = d[3] - C;
        P === 0 || F === 0 || (nt(n.context, a, P, F, n.subtype, n.backdrop, n.transferMap, x, C, n.offsetX, n.offsetY), h.save(), h.globalAlpha = 1, h.globalCompositeOperation = "source-over", h.setTransform(1, 0, 0, 1, 0, 0), h.drawImage(a.canvas, 0, 0), h.restore());
      }
      function lt(h, n) {
      ...
      class v {
        ...
        beginDrawing(n) {
          ...
          if (this.ctx.fillStyle = C || "#ffffff", this.ctx.fillRect(0, 0, P, F), this.ctx.fillStyle = O, x) {
        ...
        _scaleImage(n, a) {
          const d = n.width, x = n.height;
          let C = Math.max(Math.hypot(a[0], a[1]), 1), P = Math.max(Math.hypot(a[2], a[3]), 1), F = d, O = x, N = "prescale1", k, U;
          for (; C > 2 && F > 1 || P > 2 && O > 1; ) {
            let Y = F, G = O;
        ...
        _createMaskCanvas(n) {
          ...
          k || (U = this.cachedCanvases.getCanvas("maskCanvas", d, x), ut(U.context, n));
          let Y = s.Util.transform(F, [1 / d, 0, 0, -1 / x, 0, 0]);
          Y = s.Util.transform(Y, [1, 0, 0, 1, 0, -x]);
          const [G, I, B, st] = s.Util.getAxialAlignedBoundingBox([0, 0, d, x], Y), q = Math.round(B - G) || 1, ct = Math.round(st - I) || 1, pt = this.cachedCanvases.getCanvas("fillCanvas", q, ct), ft = pt.context, mt = G, yt = I;
          ft.translate(-mt, -yt), ft.transform(...Y), k || (k = this._scaleImage(U.canvas, (0, g.getCurrentTransformInverse)(ft)), k = k.img, O && P && O.set(N, k)), ft.imageSmoothingEnabled = lt((0, g.getCurrentTransform)(ft), n.interpolate), K(ft, k, 0, 0, k.width, k.height, 0, 0, d, x), ft.globalCompositeOperation = "source-in";
          const At = s.Util.transform((0, g.getCurrentTransformInverse)(ft), [1, 0, 0, 1, -mt, -yt]);
          return ft.fillStyle = P ? C.getPattern(a, this, At, u.FILL) : C, ft.fillRect(0, 0, d, x), O && !P && (this.cachedCanvases.delete("fillCanvas"), O.set(N, pt.canvas)), {
            canvas: pt.canvas,
        ...
        beginSMaskMode() {
          ...
          const n = this.ctx.canvas.width, a = this.ctx.canvas.height, d = "smaskGroupAt" + this.groupLevel, x = this.cachedCanvases.getCanvas(d, n, a);
        ...
        transform(n, a, d, x, C, P) {
          this.ctx.transform(n, a, d, x, C, P), this._cachedScaleForStroking[0] = -1, this._cachedGetSinglePixelWidth = null;
        }
        constructPath(n, a, d) {
          const x = this.ctx, C = this.current;
          let P = C.x, F = C.y, O, N;
          const k = (0, g.getCurrentTransform)(x), U = k[0] === 0 && k[3] === 0 || k[1] === 0 && k[2] === 0, Y = U ? d.slice(0) : null;
          for (let G = 0, I = 0, B = n.length; G < B; G++)
            switch (n[G] | 0) {
              case s.OPS.rectangle:
                P = a[I++], F = a[I++];
                const st = a[I++], q = a[I++], ct = P + st, pt = F + q;
                x.moveTo(P, F), st === 0 || q === 0 ? x.lineTo(ct, pt) : (x.lineTo(ct, F), x.lineTo(ct, pt), x.lineTo(P, pt)), U || C.updateRectMinMax(k, [P, F, ct, pt]), x.closePath();
                break;
              case s.OPS.moveTo:
                P = a[I++], F = a[I++], x.moveTo(P, F), U || C.updatePathMinMax(k, P, F);
                break;
              case s.OPS.lineTo:
                P = a[I++], F = a[I++], x.lineTo(P, F), U || C.updatePathMinMax(k, P, F);
                break;
              case s.OPS.curveTo:
                O = P, N = F, P = a[I + 4], F = a[I + 5], x.bezierCurveTo(a[I], a[I + 1], a[I + 2], a[I + 3], P, F), C.updateCurvePathMinMax(k, O, N, a[I], a[I + 1], a[I + 2], a[I + 3], P, F, Y), I += 6;
                break;
              case s.OPS.curveTo2:
                O = P, N = F, x.bezierCurveTo(P, F, a[I], a[I + 1], a[I + 2], a[I + 3]), C.updateCurvePathMinMax(k, O, N, P, F, a[I], a[I + 1], a[I + 2], a[I + 3], Y), P = a[I + 2], F = a[I + 3], I += 4;
                break;
              case s.OPS.curveTo3:
                O = P, N = F, P = a[I + 2], F = a[I + 3], x.bezierCurveTo(a[I], a[I + 1], P, F, P, F), C.updateCurvePathMinMax(k, O, N, a[I], a[I + 1], P, F, P, F, Y), I += 4;
                break;
        ...
        fill() {
          let n = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0;
          const a = this.ctx, d = this.current.fillColor, x = this.current.patternFill;
          let C = !1;
          x && (a.save(), a.fillStyle = d.getPattern(a, this, (0, g.getCurrentTransformInverse)(a), u.FILL), C = !0);
        ...
        setFont(n, a) {
          const d = this.commonObjs.get(n), x = this.current;
          if (!d)
            throw new Error(`Can't find font for ${n}`);
          if (x.fontMatrix = d.fontMatrix || s.FONT_IDENTITY_MATRIX, (x.fontMatrix[0] === 0 || x.fontMatrix[3] === 0) && (0, s.warn)("Invalid font matrix for font " + n), a < 0 ? (a = -a, x.fontDirection = -1) : x.fontDirection = 1, this.current.font = d, this.current.fontSize = a, d.isType3Font)
            return;
        ...
        setTextMatrix(n, a, d, x, C, P) {
          this.current.textMatrix = [n, a, d, x, C, P], this.current.textMatrixScale = Math.hypot(n, a), this.current.x = this.current.lineX = 0, this.current.y = this.current.lineY = 0;
        }
        nextLine() {
        ...
        showText(n) {
          ...
          if (x === 0)
            return;
          const C = this.ctx, P = a.fontSizeScale, F = a.charSpacing, O = a.wordSpacing, N = a.fontDirection, k = a.textHScale * N, U = n.length, Y = d.vertical, G = Y ? 1 : -1, I = d.defaultVMetrics, B = x * a.fontMatrix[0], st = a.textRenderingMode === s.TextRenderingMode.FILL && !d.disableFontFace && !a.patternFill;
          ...
          for (mt = 0; mt < U; ++mt) {
            ...
            if (Y) {
              const gt = yt.vmetric || I, Et = -(yt.vmetric ? gt[1] : it * 0.5) * B, St = gt[2] * B;
              it = gt ? -gt[0] : it, X = Et / P, rt = (ft + St) / P;
            } else
              X = ft / P, rt = 0;
            if (d.remeasure && it > 0) {
              const gt = C.measureText(H).width * 1e3 / x * P;
              if (it < gt && this.isFontSubpixelAAEnabled) {
                const Et = it / gt;
                At = !0, C.save(), C.scale(Et, 1), X /= Et;
              } else it !== gt && (X += (it - gt) / 2e3 * x / P);
            }
            if (this.contentVisible && (yt.isInFont || d.missingFile)) {
              if (st && !W)
                C.fillText(H, X, rt);
              else if (this.paintChar(H, X, rt, q), W) {
                const gt = X + x * W.offset.x / P, Et = rt - x * W.offset.y / P;
        ...
        showType3Text(n) {
          const a = this.ctx, d = this.current, x = d.font, C = d.fontSize, P = d.fontDirection, F = x.vertical ? 1 : -1, O = d.charSpacing, N = d.wordSpacing, k = d.textHScale * P, U = d.fontMatrix || s.FONT_IDENTITY_MATRIX, Y = n.length, G = d.textRenderingMode === s.TextRenderingMode.INVISIBLE;
          let I, B, st, q;
          if (!(G || C === 0)) {
            for (this._cachedScaleForStroking[0] = -1, this._cachedGetSinglePixelWidth = null, a.save(), a.transform(...d.textMatrix), a.translate(d.x, d.y), a.scale(k, P), I = 0; I < Y; ++I) {
              ...
              const ct = (B.isSpace ? N : 0) + O, pt = x.charProcOperatorList[B.operatorListId];
              if (!pt) {
        ...
        setCharWidthAndBounds(n, a, d, x, C, P) {
          this.ctx.rect(d, x, C - d, P - x), this.ctx.clip(), this.endPath();
        }
        getColorN_Pattern(n) {
          let a;
          if (n[0] === "TilingPattern") {
            const d = n[1], x = this.baseTransform || (0, g.getCurrentTransform)(this.ctx), C = {
              createCanvasGraphics: (P) => new v(P, this.commonObjs, this.objs, this.canvasFactory, this.filterFactory, {
                optionalContentConfig: this.optionalContentConfig,
                markedContentStack: this.markedContentStack
              })
            };
            a = new f(n, d, this.ctx, C, x);
          } else
        ...
        setStrokeRGBColor(n, a, d) {
          const x = s.Util.makeHexColor(n, a, d);
        ...
        shadingFill(n) {
          ...
          const x = (0, g.getCurrentTransformInverse)(a);
          if (x) {
            const {
              width: C,
              height: P
            } = a.canvas, [F, O, N, k] = s.Util.getAxialAlignedBoundingBox([0, 0, C, P], x);
        ...
        paintFormXObjectBegin(n, a) {
          if (this.contentVisible && (this.save(), this.baseTransformStack.push(this.baseTransform), Array.isArray(n) && n.length === 6 && this.transform(...n), this.baseTransform = (0, g.getCurrentTransform)(this.ctx), a)) {
            const d = a[2] - a[0], x = a[3] - a[1];
            this.ctx.rect(a[0], a[1], d, x), this.current.updateRectMinMax((0, g.getCurrentTransform)(this.ctx), a), this.clip(), this.endPath();
          }
        }
        paintFormXObjectEnd() {
        ...
        beginGroup(n) {
          ...
          let x = s.Util.getAxialAlignedBoundingBox(n.bbox, (0, g.getCurrentTransform)(a));
          const C = [0, 0, a.canvas.width, a.canvas.height];
          x = s.Util.intersect(x, C) || [0, 0, 0, 0];
          const P = Math.floor(x[0]), F = Math.floor(x[1]);
          let O = Math.max(Math.ceil(x[2]) - P, 1), N = Math.max(Math.ceil(x[3]) - F, 1), k = 1, U = 1;
        ...
        endGroup(n) {
          ...
          if (this.ctx = d, this.ctx.imageSmoothingEnabled = !1, n.smask)
            ...
            this.ctx.restore();
            const x = (0, g.getCurrentTransform)(this.ctx);
            this.restore(), this.ctx.save(), this.ctx.setTransform(...x);
            const C = s.Util.getAxialAlignedBoundingBox([0, 0, a.canvas.width, a.canvas.height], x);
            this.ctx.drawImage(a.canvas, 0, 0), this.ctx.restore(), this.compose(C);
          }
        }
        beginAnnotation(n, a, d, x, C) {
          ...
          this.current = new J(this.ctx.canvas.width, this.ctx.canvas.height), this.transform(...d), this.transform(...x);
        }
        endAnnotation() {
        ...
        paintImageMaskXObject(n) {
          ...
          const d = this.ctx, x = this.processingType3;
          if (x && (x.compiled === void 0 && (x.compiled = Q(n)), x.compiled)) {
            x.compiled(d);
            return;
          }
        ...
        paintImageMaskXObjectRepeat(n, a) {
          let d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, x = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : 0, C = arguments.length > 4 ? arguments[4] : void 0, P = arguments.length > 5 ? arguments[5] : void 0;
          if (!this.contentVisible)
            return;
        ...
        paintImageMaskXObjectGroup(n) {
          ...
          for (const C of n) {
            ...
            ut(U, Y), U.globalCompositeOperation = "source-in", U.fillStyle = x ? d.getPattern(U, this, (0, g.getCurrentTransformInverse)(a), u.FILL) : d, U.fillRect(0, 0, F, O), U.restore(), a.save(), a.transform(...N), a.scale(1, -1), K(a, k.canvas, 0, 0, F, O, 0, -1, 1, 1), a.restore();
          }
          this.compose();
        }
        paintImageXObject(n) {
        ...
        paintImageXObjectRepeat(n, a, d, x) {
          if (!this.contentVisible)
            return;
          ...
          for (let N = 0, k = x.length; N < k; N += 2)
            O.push({
              transform: [a, 0, 0, d, x[N], x[N + 1]],
              x: 0,
              y: 0,
              w: P,
              h: F
        ...
        paintInlineImageXObject(n) {
          ...
          const P = this._scaleImage(C, (0, g.getCurrentTransformInverse)(x));
          x.imageSmoothingEnabled = lt((0, g.getCurrentTransform)(x), n.interpolate), K(x, P.img, 0, 0, P.paintWidth, P.paintHeight, 0, -d, a, d), this.compose(), this.restore();
        }
        paintInlineImageXObjectGroup(n, a) {
          ...
          if (n.bitmap)
            ...
            at(O, n), x = this.applyTransferMapsToCanvas(O);
          }
          for (const C of a)
            d.save(), d.transform(...C.transform), d.scale(1, -1), K(d, x, C.x, C.y, C.w, C.h, 0, -1, 1, 1), d.restore();
          this.compose();
        }
        ...
        getSinglePixelWidth() {
          if (!this._cachedGetSinglePixelWidth) {
            ...
            if (n[1] === 0 && n[2] === 0)
              ...
              const a = Math.abs(n[0] * n[3] - n[2] * n[1]), d = Math.hypot(n[0], n[2]), x = Math.hypot(n[1], n[3]);
              this._cachedGetSinglePixelWidth = Math.max(d, x) / a;
            }
          }
        ...
        getScaleForStroking() {
          if (this._cachedScaleForStroking[0] === -1) {
            ...
            if (d === 0 && x === 0) {
              ...
              const O = Math.abs(a * C - d * x), N = Math.hypot(a, d), k = Math.hypot(x, C);
              if (n === 0)
                P = k / O, F = N / O;
              else {
                const U = n * O;
        ...
        rescaleAndStroke(n) {
          const {
            ...
            lineWidth: d
          } = this.current, [x, C] = this.getScaleForStroking();
          if (a.lineWidth = d || 1, x === 1 && C === 1) {
            a.stroke();
            return;
          }
          const P = a.getLineDash();
          if (n && a.save(), a.scale(x, C), P.length > 0) {
            const F = Math.max(x, C);
  ...
  473: (
    ...
    ((w, D, t) => {
      ...
      class m extends s.BaseFilterFactory {
        ...
        get #d() {
          if (!this.#e) {
            ...
            const nt = this.#s.createElementNS(S, "svg");
            nt.setAttribute("width", 0), nt.setAttribute("height", 0), this.#e = this.#s.createElementNS(S, "defs"), z.append(nt), nt.append(this.#e), this.#s.body.append(z);
          }
          return this.#e;
        }
        addFilter(z) {
          ...
          if (z.length === 1) {
            ...
            const [v, h, n] = z, a = new Array(256), d = new Array(256), x = new Array(256);
            for (let C = 0; C < 256; C++)
              a[C] = v[C] / 255, d[C] = h[C] / 255, x[C] = n[C] / 255;
            nt = a.join(","), ot = d.join(","), lt = x.join(","), vt = `${nt}${ot}${lt}`;
          }
          if (V = this.#u.get(vt), V)
            return this.#u.set(z, V), V;
          const Tt = `g_${this.#n}_transfer_map_${this.#f++}`, xt = `url(#${Tt})`;
          this.#u.set(z, xt), this.#u.set(vt, xt);
          const tt = this.#p(Tt);
          return this.#v(nt, ot, lt, tt), xt;
        }
        addHCMFilter(z, V) {
          const nt = `${z}-${V}`;
          if (this.#i === nt)
          ...
          const Tt = vt.join(","), xt = `g_${this.#n}_hcm_filter`, tt = this.#l = this.#p(xt);
          this.#v(Tt, Tt, Tt, tt), this.#a(tt);
          const v = (h, n) => {
            const a = ot[h] / 255, d = lt[h] / 255, x = new Array(n + 1);
            for (let C = 0; C <= n; C++)
              x[C] = a + C / n * (d - a);
            return x.join(",");
          };
          return this.#v(v(0, 5), v(1, 5), v(2, 5), tt), this.#o = `url(#${xt})`, this.#o;
        }
        addHighlightHCMFilter(z, V, nt, ot) {
          ...
          let xt = Math.round(0.2126 * vt[0] + 0.7152 * vt[1] + 0.0722 * vt[2]), tt = Math.round(0.2126 * Tt[0] + 0.7152 * Tt[1] + 0.0722 * Tt[2]), [v, h] = [nt, ot].map(this.#y.bind(this));
          tt < xt && ([xt, tt, v, h] = [tt, xt, h, v]), this.#d.style.color = "";
          const n = (x, C, P) => {
            const F = new Array(256), O = (tt - xt) / P, N = x / 255, k = (C - x) / (255 * P);
            let U = 0;
            for (let Y = 0; Y <= P; Y++) {
              const G = Math.round(xt + Y * O), I = N + Y * k;
              for (let B = U; B <= G; B++)
                F[B] = I;
              U = G + 1;
            }
        ...
        #a(z) {
          const V = this.#s.createElementNS(S, "feColorMatrix");
      ...
      class f extends s.BaseSVGFactory {
        _createSVG(z) {
          return document.createElementNS(S, z);
        }
      }
      class e {
        constructor(z) {
          ...
          const xt = (V[2] + V[0]) / 2, tt = (V[3] + V[1]) / 2;
          let v, h, n, a;
          ...
          Tt && (n = -n, a = -a);
          let d, x, C, P;
          v === 0 ? (d = Math.abs(tt - V[1]) * nt + lt, x = Math.abs(xt - V[0]) * nt + vt, C = (V[3] - V[1]) * nt, P = (V[2] - V[0]) * nt) : (d = Math.abs(xt - V[0]) * nt + lt, x = Math.abs(tt - V[1]) * nt + vt, C = (V[2] - V[0]) * nt, P = (V[3] - V[1]) * nt), this.transform = [v * nt, h * nt, n * nt, a * nt, d - v * nt * xt - n * nt * tt, x - h * nt * xt - a * nt * tt], this.width = C, this.height = P;
        }
        get rawDims() {
          const {
            viewBox: z
...
`);
      ...
      class K {
        static toDateObject(z) {
          ...
          Tt = Tt >= 0 && Tt <= 59 ? Tt : 0;
          let xt = parseInt(V[6], 10);
          xt = xt >= 0 && xt <= 59 ? xt : 0;
          const tt = V[7] || "Z";
          let v = parseInt(V[8], 10);
          v = v >= 0 && v <= 23 ? v : 0;
          let h = parseInt(V[9], 10) || 0;
          return h = h >= 0 && h <= 59 ? h : 0, tt === "-" ? (vt += v, Tt += h) : tt === "+" && (vt -= v, Tt -= h), new Date(Date.UTC(nt, ot, lt, vt, Tt, xt));
        }
      }
      function Q(Z, z) {
        let {
      ...
      function _(Z, z) {
        ...
        if (z instanceof e) {
          const {
            ...
            style: vt
          } = Z, Tt = g.FeatureTest.isCSSRoundSupported, xt = `var(--scale-factor) * ${ot}px`, tt = `var(--scale-factor) * ${lt}px`, v = Tt ? `round(${xt}, 1px)` : `calc(${xt})`, h = Tt ? `round(${tt}, 1px)` : `calc(${tt})`;
  ...
  9423: (
    ...
    ((w, D, t) => {
      ...
      class u {
        ...
        #r(b) {
          const S = u._svgFactory.create(1, 1, !0);
          return this.#t.append(S), u.#s(S, b), S;
        }
        highlight(b, S, p) {
          let {
            outlines: m,
          ...
          return c.append(E), c.setAttribute("fill", S), c.setAttribute("fill-opacity", p), E.setAttribute("href", `#${e}`), this.#n.set(l, c), {
            id: l,
            clipPathId: `url(#${y})`
          };
        }
        highlightOutline(b) {
          ...
          c.setAttribute("id", r), c.setAttribute("d", u.#i(S)), c.setAttribute("vector-effect", "non-scaling-stroke");
        ...
        static #i(b) {
          ...
          for (const p of b) {
            ...
            for (let l = 2; l < p.length; l += 2) {
              const c = p[l], r = p[l + 1];
              c === m ? (S.push(`V${r}`), o = r) : r === o && (S.push(`H${c}`), m = c);
            }
            S.push("Z");
          }
          return S.join(" ");
        ...
        rotate(b, S) {
          this.#n.get(b).setAttribute("data-main-rotation", S);
        }
        changeColor(b, S) {
          this.#n.get(b).setAttribute("fill", S);
        }
        changeOpacity(b, S) {
          this.#n.get(b).setAttribute("fill-opacity", S);
        }
        addClass(b, S) {
          this.#n.get(b).classList.add(S);
        }
        removeClass(b, S) {
          this.#n.get(b).classList.remove(S);
        }
        remove(b) {
...
`),
      ...
      class m extends g.AnnotationEditor {
        ...
        async addEditToolbar() {
          ...
          return e ? (this._uiManager.highlightColors && (this.#n = new S.ColorPicker({
            editor: this
      ...
      class l extends g.AnnotationEditor {
        ...
        #y(e) {
          ...
          this.addCommands({
            cmd: () => {
              this.opacity = e, this.#S();
            },
            undo: () => {
              this.opacity = i, this.#S();
            },
            mustExec: !0,
        ...
        rebuild() {
          this.parent && (super.rebuild(), this.div !== null && (this.canvas || (this.#C(), this.#x()), this.isAttachedToDOM || (this.parent.add(this), this.#F()), this.#I()));
        }
        remove() {
        ...
        #L(e, i) {
          ...
          const R = () => {
            ...
            this.allRawPaths.pop(), this.paths.pop(), this.bezierPath2D.pop(), this.paths.length === 0 ? this.remove() : (this.canvas || (this.#C(), this.#x()), this.#I());
          };
          this.addCommands({
            cmd: R,
            undo: L,
        ...
        render() {
          ...
          if (this.setAt(y, T, 0, 0), this.setDims(E, R), this.#C(), this.width) {
            ...
            this.setAspectRatio(this.width * L, this.height * M), this.setAt(e * L, i * M, this.width * L, this.height * M), this.#f = !0, this.#F(), this.setDims(this.width * L, this.height * M), this.#S(), this.div.classList.add("disabled");
          } else
            this.div.classList.add("editing"), this.enableEditMode();
          return this.#x(), this.div;
        }
        #F() {
          if (!this.#f)
            return;
        ...
        setDimensions(e, i) {
          ...
          this.width = e / E, this.height = i / R, this.fixAndSetPosition(), this.#h && this.#H(e, i), this.#F(), this.#S(), this.canvas.style.visibility = "visible", this.fixDims();
        }
        #H(e, i) {
        ...
        #I() {
          ...
          this.translationX = -i[0], this.translationY = -i[1], this.#F(), this.#S(), this.#d = T, this.#a = E, this.setDims(T, E);
        ...
        static deserialize(e, i, y) {
          ...
          for (let {
            ...
            for (let V = 2, nt = ut.length; V < nt; V += 6) {
              const ot = $ * (ut[V] - j), lt = $ * (ut[V + 1] - j), vt = $ * (ut[V + 2] - j), Tt = $ * (ut[V + 3] - j), xt = $ * (ut[V + 4] - j), tt = $ * (ut[V + 5] - j);
              ht.push([[_, Z], [ot, lt], [vt, Tt], [xt, tt]]), _ = xt, Z = tt;
            }
            const z = this.#R(ht);
    ...
    ((w, D, t) => {
      ...
      class A {
        ...
        renderButton() {
          ...
          S.className = "colorPicker", S.tabIndex = "0", S.setAttribute("data-l10n-id", "pdfjs-editor-colorpicker-button"), S.setAttribute("aria-haspopup", !0), S.addEventListener("click", this.#d.bind(this));
          const p = this.#n = document.createElement("span");
          return p.className = "swatch", p.style.backgroundColor = this.#s, S.append(p), S;
        }
        renderMainDropdown() {
          const S = this.#r = this.#c(s.AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR);
          return S.setAttribute("aria-orientation", "horizontal"), S.setAttribute("aria-labelledby", "highlightColorPickerLabel"), S;
        }
        #c(S) {
          ...
          for (const [m, o] of this.#h.highlightColors) {
            ...
            const c = document.createElement("span");
            l.append(c), c.className = "swatch", c.style.backgroundColor = o, l.setAttribute("aria-selected", o === this.#s), l.addEventListener("click", this.#f.bind(this, S, o)), p.append(l);
          }
        ...
        _colorSelectFromKeyboard(S) {
          const p = S.target.getAttribute("data-color");
          p && this.#f(p, S);
        }
        _moveToNext(S) {
          if (S.target === this.#e) {
          ...
          S.target.nextSibling?.focus();
        }
        _moveToPrevious(S) {
          S.target.previousSibling?.focus();
        }
        _moveToBeginning() {
          this.#r.firstChild?.focus();
        }
        ...
        #u(S) {
          A._keyboardManager.exec(this, S);
        }
        #d(S) {
          ...
          if (this.#e.addEventListener("keydown", this.#t), this.#i = S.detail === 0, this.#r) {
        ...
        updateColor(S) {
          if (this.#n && (this.#n.style.backgroundColor = S), !this.#r)
            return;
          const p = this.#h.highlightColors.values();
          for (const m of this.#r.children)
            m.setAttribute("aria-selected", p.next().value === S);
        }
        destroy() {
    ...
    ((w, D, t) => {
      ...
      class S {
        ...
        static get _resizerKeyboardManager() {
          const o = S.prototype._resizeWithKeyboard, l = s.AnnotationEditorUIManager.TRANSLATE_SMALL, c = s.AnnotationEditorUIManager.TRANSLATE_BIG;
          return (0, g.shadow)(this, "_resizerKeyboardManager", new s.KeyboardManager([[["ArrowLeft", "mac+ArrowLeft"], o, {
            ...
            args: [0, c]
          }], [["Escape", "mac+Escape"], S.prototype._stopResizingWithKeyboard]]));
        }
        constructor(o) {
          this.constructor === S && (0, g.unreachable)("Cannot initialize AnnotationEditor."), this.parent = o.parent, this.id = o.id, this.width = this.height = null, this.pageIndex = o.parent.pageIndex, this.name = o.name, this.div = null, this._uiManager = o.uiManager, this.annotationElementId = null, this._willKeepAspectRatio = !1, this._initialOptions.isCentered = o.isCentered, this._structTreeParentId = null;
          const {
            rotation: l,
            rawDims: {
              pageWidth: c,
        ...
        static initialize(o) {
          ...
          if (S._l10nPromise ||= new Map(["pdfjs-editor-alt-text-button-label", "pdfjs-editor-alt-text-edit-button-label", "pdfjs-editor-alt-text-decorative-tooltip", "pdfjs-editor-resizer-label-topLeft", "pdfjs-editor-resizer-label-topMiddle", "pdfjs-editor-resizer-label-topRight", "pdfjs-editor-resizer-label-middleRight", "pdfjs-editor-resizer-label-bottomRight", "pdfjs-editor-resizer-label-bottomMiddle", "pdfjs-editor-resizer-label-bottomLeft", "pdfjs-editor-resizer-label-middleLeft"].map((r) => [r, o.get(r.replaceAll(/([A-Z])/g, (f) => `-${f.toLowerCase()}`))])), l?.strings)
            for (const r of l.strings)
              S._l10nPromise.set(r, o.get(r));
          if (S._borderLineWidth !== -1)
            return;
          const c = getComputedStyle(document.documentElement);
          S._borderLineWidth = parseFloat(c.getPropertyValue("--outline-width")) || 0;
        }
        ...
        setParent(o) {
          o !== null ? (this.pageIndex = o.pageIndex, this.pageDimensions = o.pageDimensions) : this.#x(), this.parent = o;
        }
        focusin(o) {
        ...
        screenToPageTranslation(o, l) {
          return S.#b(o, l, this.parentRotation);
        }
        pageTranslationToScreen(o, l) {
          return S.#b(o, l, 360 - this.parentRotation);
        }
        #A(o) {
          switch (o) {
            case 90: {
        ...
        #L(o, l) {
          const [c, r] = this.parentDimensions, f = this.x, e = this.y, i = this.width, y = this.height, T = S.MIN_SIZE / c, E = S.MIN_SIZE / r, R = (v) => Math.round(v * 1e4) / 1e4, L = this.#A(this.rotation), M = (v, h) => [L[0] * v + L[2] * h, L[1] * v + L[3] * h], $ = this.#A(360 - this.rotation), j = (v, h) => [$[0] * v + $[2] * h, $[1] * v + $[3] * h];
          let K, Q, J = !1, at = !1;
          switch (o) {
            case "topLeft":
          ...
          _ = M(...Q(vt, Tt));
          const xt = Z - _[0], tt = z - _[1];
          this.width = vt, this.height = Tt, this.x = xt, this.y = tt, this.setDims(c * vt, r * Tt), this.fixAndSetPosition();
        }
        altTextFinish() {
          this.#e?.finish();
        }
        ...
        async addAltTextButton() {
          this.#e || (A.initialize(S._l10nPromise), this.#e = new A(this), await this.addEditToolbar());
        }
        get altTextData() {
          return this.#e?.data;
        }
        ...
        remove() {
          this.div.removeEventListener("focusin", this.#i), this.div.removeEventListener("focusout", this.#o), this.isEmpty() || this.commit(), this.parent ? this.parent.remove(this) : this._uiManager.removeEditor(this), this.#a && (clearTimeout(this.#a), this.#a = null), this.#x(), this.removeEditToolbar();
        }
        get isResizable() {
          return !1;
        }
        ...
        keydown(o) {
          ...
          if (!this.#t) {
            this.#t = Array.from(l);
            const e = this.#N.bind(this), i = this.#S.bind(this);
            for (const y of this.#t) {
              const T = y.getAttribute("data-resizer-name");
              y.setAttribute("role", "spinbutton"), y.addEventListener("keydown", e), y.addEventListener("blur", i), y.addEventListener("focus", this.#O.bind(this, T)), S._l10nPromise.get(`pdfjs-editor-resizer-label-${T}`).then((E) => y.setAttribute("aria-label", E));
            }
          }
          const c = this.#t[0];
          let r = 0;
          ...
          if (f !== r) {
            ...
            for (const i of l) {
              ...
              S._l10nPromise.get(`pdfjs-editor-resizer-label-${T}`).then((E) => i.setAttribute("aria-label", E));
            }
          }
        ...
        #N(o) {
          S._resizerKeyboardManager.exec(this, o);
        }
        #S(o) {
          this.#d && o.relatedTarget?.parentNode !== this.#s && this.#x();
        }
        #O(o) {
          this.#h = this.#d ? o : "";
        }
  ...
  7405: (
    ...
    ((w, D, t) => {
      ...
      class s {
        ...
        #n = [];
        constructor(u) {
          let A = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, b = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 0, S = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, p = 1 / 0, m = -1 / 0, o = 1 / 0, l = -1 / 0;
          const c = 10 ** -4;
          for (const {
            x: E,
            y: R,
          ...
          const r = m - p + 2 * b, f = l - o + 2 * b, e = p - b, i = o - b, y = this.#e.at(S ? -1 : -2), T = [y[0], y[2]];
        ...
        #r(u) {
          const A = this.#n;
          let b = 0, S = A.length - 1;
          for (; b <= S; ) {
            const p = b + S >> 1, m = A[p][0];
            if (m === u)
              return p;
            m < u ? b = p + 1 : S = p - 1;
          }
        ...
        #i(u) {
          let [, A, b] = u;
          const S = this.#r(A);
          this.#n.splice(S, 0, [A, b]);
        }
        #o(u) {
          let [, A, b] = u;
          const S = this.#r(A);
          for (let p = S; p < this.#n.length; p++) {
            const [m, o] = this.#n[p];
            if (m !== A)
              break;
            if (m === A && o === b) {
        ...
        #l(u) {
          const [A, b, S] = u, p = [[A, b, S]], m = this.#r(S);
          for (let o = 0; o < m; o++) {
            const [l, c] = this.#n[o];
    ...
    ((w, D, t) => {
        ...
        async #s(r, f) {
          ...
          try {
            ...
            if (typeof f == "string" ? (e.url = f, i = await (0, g.fetchData)(f, "blob")) : i = e.file = f, i.type === "image/svg+xml") {
              const y = S._isSVGFittingCanvas, T = new FileReader(), E = new Image(), R = new Promise((L, M) => {
                E.onload = () => {
      ...
      class l {
        ...
        constructor(r, f, e, i, y, T, E) {
          this.#P = r, this.#U = f, this.#s = e, this._eventBus = i, this._eventBus._on("editingaction", this.#O), this._eventBus._on("pagechanging", this.#C), this._eventBus._on("scalechanging", this.#x), this._eventBus._on("rotationchanging", this.#F), this.#r = y.annotationStorage, this.#u = y.filterFactory, this.#T = T, this.#a = E || null, this.viewParameters = {
            realScale: g.PixelsPerInch.PDF_TO_CSS_UNITS,
            rotation: 0
          };
        }
        destroy() {
          this.#I(), this.#j(), this._eventBus._off("editingaction", this.#O), this._eventBus._off("pagechanging", this.#C), this._eventBus._off("scalechanging", this.#x), this._eventBus._off("rotationchanging", this.#F);
        ...
        #B() {
          window.addEventListener("keydown", this.#S);
        }
        #I() {
          window.removeEventListener("keydown", this.#S);
        }
        #G() {
        ...
        get imageManager() {
          return (0, s.shadow)(this, "imageManager", new S());
        }
      }
    })
  ),
    ...
    ((w, D, t) => {
      ...
      class g {
        ...
        insertRule(b) {
          ...
          const S = this.styleElement.sheet;
          S.insertRule(b, S.cssRules.length);
        }
        clear() {
          ...
          if (!(!S || this.#t.has(S.loadedName))) {
            if ((0, s.assert)(!this.disableFontFace, "loadSystemFont shouldn't be called when `disableFontFace` is set."), this.isFontLoadingAPISupported) {
              const {
                ...
                src: o,
                style: l
              } = S, c = new FontFace(m, o, l);
              this.addNativeFontFace(c);
              try {
                await c.load(), this.#t.add(m), p?.(S);
              } catch {
                (0, s.warn)(`Cannot load system font: ${S.baseFontName}, installing it could help to improve PDF rendering.`), this.removeNativeFontFace(c);
              }
              return;
            }
        ...
        async bind(b) {
          ...
          const S = b.createFontFaceRule();
          if (S) {
            if (this.insertRule(S), this.isSyncFontLoadingSupported)
              return;
            await new Promise((p) => {
      ...
      class u {
        ...
        createNativeFontFace() {
          ...
          if (!this.cssFontInfo)
            ...
            this.cssFontInfo.italicAngle && (S.style = `oblique ${this.cssFontInfo.italicAngle}deg`), b = new FontFace(this.cssFontInfo.fontFamily, this.data, S);
          }
        ...
        createFontFaceRule() {
          if (!this.data || this.disableFontFace)
            return null;
          const b = (0, s.bytesToString)(this.data), S = `url(data:${this.mimetype};base64,${btoa(b)});`;
          let p;
          if (!this.cssFontInfo)
            p = `@font-face {font-family:"${this.loadedName}";src:${S}}`;
          else {
            let m = `font-weight: ${this.cssFontInfo.fontWeight};`;
            this.cssFontInfo.italicAngle && (m += `font-style: oblique ${this.cssFontInfo.italicAngle}deg;`), p = `@font-face {font-family:"${this.cssFontInfo.fontFamily}";${m}src:${S}}`;
          }
          return this._inspectFont?.(this, S), p;
        }
        getPathGenerator(b, S) {
          if (this.compiledGlyphs[S] !== void 0)
            return this.compiledGlyphs[S];
          let p;
          try {
            p = b.get(this.loadedName + "_path_" + S);
          } catch (m) {
            if (!this.ignoreErrors)
              throw m;
            return (0, s.warn)(`getPathGenerator - ignoring character: "${m}".`), this.compiledGlyphs[S] = function(o, l) {
            };
          }
...
`);
            ...
            return this.compiledGlyphs[S] = new Function("c", "size", m.join(""));
          }
          return this.compiledGlyphs[S] = function(m, o) {
            for (const l of p)
  ...
  3474: (
    ...
    ((w, D, t) => {
      ...
      class p {
        constructor(c) {
          this._source = c, this._manager = new S(c.url, {
    ...
    ((w, D, t) => {
      t.a(w, async (s, g) => {
        try {
          ...
          var u = t(4226), A = t(8837), b = t(9803), S = t(8347), p = t(7995), m = t(62), o = t(4602), l = t(344), c = t(4305), r = t(7583), f = t(3266), e = t(8253);
          let i, y, T, E;
    ...
    ((w, D, t) => {
      t.a(w, async (s, g) => {
        try {
          ...
          var u = t(3352), A = t(8837), b = t(9803), S = t(8347), p = t(7995), m = t(62), o = t(4602), l = t(344), c = t(4305), r = t(7583), f = t(6822), e = t(3266);
          let i, y, T;
          if (e.isNodeJS) {
            i = await import(
              /* webpackIgnore: true */
  ...
  5739: (
    ...
    ((w, D, t) => {
      ...
      var s = t(3266), g = t(473);
      const u = 1e5, A = 30, b = 0.8, S = /* @__PURE__ */ new Map();
      function p(i, y) {
        let T;
      ...
      function m(i, y) {
        ...
        if (L) {
          const j = L / (L + M);
          return S.set(i, j), E.canvas.width = E.canvas.height = 0, j;
        }
    ...
    ((w, D, t) => {
      ...
      class g {
          ...
          switch (S.name) {
            ...
            case "input":
              if (S.attributes.type === "radio" || S.attributes.type === "checkbox") {
                if (o.value === S.attributes.xfaOn ? A.setAttribute("checked", !0) : o.value === S.attributes.xfaOff && A.removeAttribute("checked"), m === "print")
                  break;
        ...
        static setAttributes(A) {
          ...
          const {
            attributes: l
          } = S, c = b instanceof HTMLAnchorElement;
          ...
          c && o.addLinkAttributes(b, l.href, l.newWindow), p && l.dataId && this.setupStorage(b, l.dataId, S, p);
        }
        static render(A) {
          const b = A.annotationStorage, S = A.linkService, p = A.xfaHtml, m = A.intent || "display", o = document.createElement(p.name);
    ...
    ((w, D, t) => {
      t.a(w, async (s, g) => {
        try {
          ...
          var u = t(3266), A = t(9406), b = t(473), S = t(5739), p = t(4629), m = t(4812), o = t(7640), l = t(5097), c = t(9423), r = t(1368), f = t(7405), e = t(8266), i = s([A]);
  ...
  6694: (
    ...
    ((w, D, t) => {
      ...
      function A(S) {
        switch (S instanceof Error || typeof S == "object" && S !== null || (0, s.unreachable)('wrapReason: Expected "reason" to be a (possibly cloned) Error.'), S.name) {
          case "AbortException":
            return new s.AbortException(S.message);
          case "MissingPDFException":
            return new s.MissingPDFException(S.message);
          case "PasswordException":
            return new s.PasswordException(S.message, S.code);
          case "UnexpectedResponseException":
            return new s.UnexpectedResponseException(S.message, S.status);
          case "UnknownErrorException":
            return new s.UnknownErrorException(S.message, S.details);
          default:
            return new s.UnknownErrorException(S.message, S.toString());
        }
      }
      class b {
        constructor(p, m, o) {
  ...
  3266: (
    ...
    ((w, D, t) => {
      ...
      const s = typeof process == "object" && process + "" == "[object process]" && !process.versions.nw && !(process.versions.electron && process.type && process.type !== "browser"), g = [1, 0, 0, 1, 0, 0], u = [1e-3, 0, 0, 1e-3, 0, 0], A = 1e7, b = 1.35, S = {
        ANY: 1,
        DISPLAY: 2,
        PRINT: 4,
        SAVE: 8,
      ...
      class x {
        ...
        static bezierBoundingBox(I, B, st, q, ct, pt, ft, mt) {
          ...
          const Ct = Et;
          for (; Et--; )
            X = yt[Et], St = 1 - X, At[0][Et] = St * St * St * I + 3 * St * St * X * st + 3 * St * X * X * ct + X * X * X * ft, At[1][Et] = St * St * St * B + 3 * St * St * X * q + 3 * St * X * X * pt + X * X * X * mt;
...
(() => {
  ...
  kt.a = (u, A, b) => {
    ...
    r[D] = m, r[w] = (f) => (S && f(S), p.forEach(f), r.catch((e) => {
    })), u.exports = r, A((f) => {
      o = g(f);
      var e, i = () => o.map((T) => {
        if (T[t]) throw T[t];
        ...
        e = () => T(i), e.r = 0;
        var E = (R) => R !== S && !p.has(R) && (p.add(R), R && !R.d && (e.r++, R.push(e)));
        o.map((R) => R[w](E));
      });
      return e.r ? y : i();
    }, (f) => (f ? c(r[t] = f) : l(m), s(S))), S && S.d < 0 && (S.d = 0);
  };
})();
kt.d = (w, D) => {
  for (var t in D)
...
//# sourceMappingURL=pdf-gqnf8hY1.js.map
